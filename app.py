...
def greet_the_guest():
    ...
    return render_template('page_template.html',title="Transcribe some audio!", \
                         paragraph="Select from existing audio:", \
                         additional_html=additional_html, upload=True)
...
def transcribe():
    ...
    return render_template('page_template.html',title="Transcription", paragraph=transcription['text'])
